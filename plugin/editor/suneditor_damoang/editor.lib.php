...
function editor_html($id, $content, $is_dhtml_editor = true)
{
  ...
  if ($is_dhtml_editor && $js) {
    ...
    $html .= '<script src="https://cdn.jsdelivr.net/npm/showdown@latest/dist/showdown.min.js"></script>';
    $html .= '<script src="https://cdn.jsdelivr.net/npm/codemirror@5/lib/codemirror.min.js"></script>';
    $html .= '<script src="https://cdn.jsdelivr.net/npm/codemirror@5/mode/markdown/markdown.js"></script>';
    $html .= '<script src="https://cdn.jsdelivr.net/npm/codemirror@5/mode/css/css.js"></script>';
    $html .= '<script src="https://cdn.jsdelivr.net/npm/codemirror@5/mode/xml/xml.js"></script>';
    $html .= '<script src="https://cdn.jsdelivr.net/npm/codemirror@5/mode/htmlmixed/htmlmixed.js"></script>';
    $html .= '<link href="https://cdn.jsdelivr.net/npm/codemirror@5/lib/codemirror.min.css" rel="stylesheet"/>';
