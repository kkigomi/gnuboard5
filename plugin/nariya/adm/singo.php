        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="td_left">
                        <?php 
                        // Ensure that wr_datetime is valid
                        $datetime = isset($row2['wr_datetime']) && !empty($row2['wr_datetime']) ? date("y-m-d H:i", strtotime($row2['wr_datetime'])) : 'Invalid date';
                        echo $datetime; 
                        ?>
                    </td> <!-- New date column data -->
