...
if ($wr_content && ($member['mb_level'] >= $board['bo_comment_level']))
{
    ...
    if (isset($wr['wr_id']) && $wr['wr_id'])
    {
        ...
        // 새글 INSERT
        sql_query(" INSERT into {$g5['board_new_table']} ( bo_table, wr_id, wr_parent, bn_datetime, mb_id, wr_is_comment ) values ( '$bo_table', '$comment_id', '$wr_id', '".G5_TIME_YMDHIS."', '{$member['mb_id']}', 1 ) ");
