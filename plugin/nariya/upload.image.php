...
// 댓글 이미지 용량 제한 설정값 가져오기
$is_comment_image_limit = (isset($boset['comment_image_limit']) && $boset['comment_image_limit']) ? true : false;
$is_comment_image_size = (isset($boset['comment_image_size']) && $boset['comment_image_size']) ? $boset['comment_image_size'] : 0;

// 댓글 이미지 용량 제한이 설정되어 있으면 해당 값으로 대체
if ($is_comment_image_limit && $is_comment_image_size > 0) {
    $is_max_upload_size = $is_comment_image_size;
}
