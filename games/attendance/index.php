...
<form name="game" action="attendance_update.php" method="post">
    ...
    <div class="mx-auto m-5" style="width:200px; text-align: center;">
        <div><input class="test11" type="text" name="number" value="0" onFocus="this.blur();" style="border: 0;font-size: 4.5rem;width:150px;text-align:center"></div>
