		...
		<div class="na-menu">
			<div class="nav nav-pills nav-vertical">
				...
				<?php if (IS_SHOP) { // 쇼핑몰에서 ?>
					...
					<div id="offcanvas-shop-basic" class="mb-3">
						<div class="nav-item">
					...
					<div id="offcanvas-shop-event" class="mb-3">
						<?php
						// 이벤트
						$evrow = array();
						$evids = array();
						...
						?>
							<div class="nav-item">
								...
								<div id="shot-item-event" class="nav-collapse collapse<?php echo $show ?>" data-bs-parent="#offcanvas-shop-event">
						...
						<div class="nav-item">
							...
							?>
							<a class="nav-link dropdown-toggle collapsed" href="#shop-item-type" role="button" data-bs-toggle="collapse" data-bs-target="#shop-item-type" aria-expanded="<?php echo $expanded ?>" aria-controls="shot-item-type">
								<i class="bi-grid nav-icon"></i>
								<span class="nav-link-title">유형별</span>
							</a>
							<div id="shop-item-type" class="nav-collapse collapse<?php echo $show ?>" data-bs-parent="#offcanvas-shop-event">
								<?php
					...
					?>
						...
						<div id="offcanvas-shop-category" class="mb-3">
						<?php 
						for ($i=0; $i < count($shop_category); $i++) {
							...
							<div class="nav-item">
								...
								<div id="<?php echo $id_s1 ?>" class="nav-collapse collapse<?php echo $show ?>" data-bs-parent="#offcanvas-shop-category">
									<?php
									// 1차 서브
