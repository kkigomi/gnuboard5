    ...
    <div class="offcanvas-body pt-0">
        <div class="px-3">
            <?php if ($is_member) { ?>
                ...
                <div class="d-flex flex-grow-1 gap-1 justify-content-between my-2">
                    ...
                    <?php if ($config['cf_use_point']) { ?>
                        <div class="flex-fill">
                            <a href="<?php echo G5_BBS_URL ?>/point.php" target="_blank" class="win_point btn btn-basic d-block">
                                <i class="ms-1 bi bi-database"></i> <?php echo number_format($member['mb_point']) ?> 포인트
                            </a>
                        </div>
                    <?php } ?>
                </div>
