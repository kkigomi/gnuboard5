...
$write['as_star_cnt'] = isset($write['as_star_cnt']) ? (int)$write['as_star_cnt'] : 0;
$write['as_star_score'] = isset($write['as_star_score']) ? (int)$write['as_star_score'] : 0;
$star = na_star($write['as_star_cnt'], $write['as_star_score'], 'fa-lg '.$star_color);

// Ensure na_star returns an array with the keys 'star', 'score', 'cnt'
if (!is_array($star)) {
    $star = [
        'star' => '',
        'score' => 0,
...
<div id="viewcomment">
    ...
    <div class="clearfix f-de px-3 px-sm-0 pt-4 pt-sm-5 pb-1">
        <div class="float-left">
			<span class="mr-3">
				<?php echo $star['star'] ?>
                <?php echo sprintf("%2.1f", $star['score']) ?>
				<span class="light">/</span>
				<i class="fa fa-user text-muted"></i> <?php echo $star['cnt'] ?>
			</span>
            ...
            <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;"<?php } ?>>
                <div class="cmt-wrap position-relative mb-2">
                    ...
                    <header style="z-index:<?php echo $cmt_sv; ?>">
                        ...
                        <div class="clearfix font-weight-normal bg-light border-top text-muted f-sm px-3 py-2<?php echo $by_writer ?>">
                            <ul class="d-flex align-items-center">
                                <?php if(isset($list[$i]['as_star_score']) && $list[$i]['as_star_score']) { ?>
                                    <li class="pr-2">
                                        <?php echo na_get_star((int)$list[$i]['as_star_score'], 'fa-lg '.$star_color) ?>
                                    </li>
                                <?php } ?>
                                <li class="pr-2">
                    ...
                    <div class="clearfix pl-3">
                        ...
                        <?php } ?>
                        <input type="hidden" value="<?php echo isset($list[$i]['as_star_score']) ? (int)$list[$i]['as_star_score'] : 0; ?>" id="star_comment_<?php echo $comment_id ?>">
