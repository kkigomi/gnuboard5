...
<ul class="list-group">
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">연재 설정</label>
			<div class="col-sm-10">
				<div class="table-responsive">
					...
					<tr>
					<td class="text-center">연재 등록</td>
					<td class="text-center">
						<div class="custom-control custom-checkbox">
							<?php $boset['swrite'] = isset($boset['swrite']) ? $boset['swrite'] : ''; ?>
							<input type="checkbox" name="boset[swrite]" value="1"<?php echo get_checked('1', $boset['swrite'])?> class="custom-control-input" id="idCheck<?php echo $idn ?>">
							<label class="custom-control-label" for="idCheck<?php echo $idn; $idn++; ?>"></label>
						</div>
					</td>
					<td class="text-muted">
						표지글 등록회원 뿐만 아니라 누구나 연재글 등록이 가능하도록 허용
					</td>
					</tr>
					<tr>
					<td class="text-center">표지 갱신</td>
					<td class="text-center">
						<div class="custom-control custom-checkbox">
							<?php $boset['supdate'] = isset($boset['supdate']) ? $boset['supdate'] : ''; ?>
							<input type="checkbox" name="boset[supdate]" value="1"<?php echo get_checked('1', $boset['supdate'])?> class="custom-control-input" id="idCheck<?php echo $idn ?>">
							<label class="custom-control-label" for="idCheck<?php echo $idn; $idn++; ?>"></label>
						</div>
					</td>
					<td class="text-muted">
					...
					<tr>
					<td class="text-center">연재 검색</td>
					<td class="text-center">
						<div class="custom-control custom-checkbox">
							<?php $boset['sstx'] = isset($boset['sstx']) ? $boset['sstx'] : ''; ?>
							<input type="checkbox" name="boset[sstx]" value="1"<?php echo get_checked('1', $boset['sstx'])?> class="custom-control-input" id="idCheck<?php echo $idn ?>">
							<label class="custom-control-label" for="idCheck<?php echo $idn; $idn++; ?>"></label>
						</div>
					</td>
					<td class="text-muted">
						검색시 글 목록에 연재글 검색결과도 출력 허용
					</td>
					</tr>
					<tr>
					...
					<td class="text-center">
						<div class="input-group">
							<?php $boset['spage_rows'] = (isset($boset['spage_rows']) && (int)$boset['spage_rows']) ? $boset['spage_rows'] : 10; ?>
							<input type="text" name="boset[spage_rows]" value="<?php echo $boset['spage_rows'] ?>" class="form-control">
					...
					<td class="text-center">
						<div class="input-group">
							<?php $boset['smpage_rows'] = (isset($boset['smpage_rows']) && (int)$boset['smpage_rows']) ? $boset['smpage_rows'] : 10; ?>
							<input type="text" name="boset[smpage_rows]" value="<?php echo $boset['smpage_rows'] ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">개</span>
							</div>
						</div>
					...
					<tr>
					<td class="text-center">회원 지정</td>
					<td colspan="2">
						<?php $boset['smb_list'] = isset($boset['smb_list']) ? $boset['smb_list'] : ''; ?>
						<input type="text" name="boset[smb_list]" value="<?php echo $boset['smb_list'] ?>" class="form-control">
						<p class="form-text text-muted">
							표지 등록이 가능한 회원아이디를 콤마(,)구분해서 띄어쓰기 없이 등록
						</p>
					</td>
					</tr>
					</tbody>
