						...
						<div class="btn-group" role="group">
							...
							<div class="dropdown-menu dropdown-menu-right p-0 border-0 bg-transparent text-right">
								<div class="btn-group-vertical">
									...
									<?php } ?>
									<?php if ($is_checkbox) { ?>
										<?php if ($is_serial_admin) { ?>
											<a href="<?php echo short_url_clean(G5_HTTP_BBS_URL.'/board.php?bo_table='.$bo_table.'&amp;act=off') ?>" class="btn btn-primary py-2" role="button">
												<i class="fa fa-bars fa-fw" aria-hidden="true"></i> 표지글
											</a>
										<?php } else { ?>
											<a href="<?php echo short_url_clean(G5_HTTP_BBS_URL.'/board.php?bo_table='.$bo_table.'&amp;act=on') ?>" class="btn btn-primary py-2" role="button">
												<i class="fa fa-bars fa-fw" aria-hidden="true"></i> 전체글
											</a>
										<?php } ?>
										<button type="submit" name="btn_submit" value="표지지정" onclick="document.pressed=this.value" class="btn btn-primary py-2">
...
function select_copy(sw) {
	...
	if(sw == "book") {
		f.action = "<?php echo $board_skin_url ?>/book.php";
	} else {
