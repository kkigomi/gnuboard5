...
<ul class="list-group">
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">태그 설정</label>
			<div class="col-sm-10">
				<style>
				...
				<p class="form-control-plaintext">
					<ol class="mb-2 pl-3">
						<li>기능설정 > 부가기능에 있는 태그 등록을 설정해야 작동하며, 마우스 드래그로 항목간 위치 이동이 가능함</li>
						<li>탭이름과 태그 모두 입력해야 출력되며, 태그는 콤마(,)로 구분해서 등록, 특수문자 사용 불가</li>
					</ol>
				</p>
				...
				<div class="table-responsive">
					...
					<thead>
					<tr class="bg-light">
						<th class="text-center nw-15">탭이름</th>
					...
					// 직접등록 입력폼 
					$data = array();
					$data_cnt = (is_array($boset['d']['tag'])) ? count($boset['d']['tag']) : 1;
					...
					?>
						...
						<td>
							<input type="text" id="tab_<?php echo $n ?>" name="boset[d][tab][]" value="<?php echo $boset['d']['tab'][$i] ?>" class="form-control">
						</td>
						<td>
							<textarea id="tag_<?php echo $n ?>" name="boset[d][tag][]" rows="2" class="form-control"><?php echo $boset['d']['tag'][$i] ?></textarea>
						</td>
				...
				<div class="table-responsive">
					...
					<tbody>
					<tr class="bg-light">
					<th class="text-center nw-c1">태그 배치</th>
					...
					<td>
						<div class="input-group">
							<input name="boset[txl]" value="<?php echo isset($boset['txl']) ? $boset['txl'] : '5'; ?>" class="form-control">
					...
					<td>
						<div class="input-group">
							<input name="boset[tlg]" value="<?php echo isset($boset['tlg']) ? $boset['tlg'] : '4'; ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">개</span>
							</div>
						</div>
					...
					<td>
						<div class="input-group">
							<input name="boset[tmd]" value="<?php echo isset($boset['tmd']) ? $boset['tmd'] : '3'; ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">개</span>
							</div>
						</div>
					...
					<td>
						<div class="input-group">
							<input name="boset[tsm]" value="<?php echo isset($boset['tsm']) ? $boset['tsm'] : '3'; ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">개</span>
							</div>
						</div>
					...
					<td>
						<div class="input-group">
							<input name="boset[txs]" value="<?php echo isset($boset['txs']) ? $boset['txs'] : '2'; ?>" class="form-control">
							<div class="input-group-append">
								<span class="input-group-text">개</span>
							</div>
						</div>
		...
		$(document).ready(function () {
			...
			$("#addrow").on("click", function () {
				...
				cols += '<td>';
				cols += '	<input type="text" id="tab_' + counter + '" name="boset[d][tab][]" class="form-control">';
				cols += '</td>';
				cols += '<td>';
				cols += '	<textarea id="tag_' + counter + '" name="boset[d][tag][]" rows="2" class="form-control"></textarea>';
				cols += '</td>';
