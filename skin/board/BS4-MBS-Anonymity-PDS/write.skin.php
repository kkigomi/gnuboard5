...
<section id="bo_w" class="f-de font-weight-normal mb-4">
	...
	<?php 
	// 첨부파일	
	if ($is_file && (int)$board['bo_upload_count'] > 0) {
		// 적립율
		$save_rate = isset($boset['save_rate']) ? (int)$boset['save_rate'] : 100;
	?>
		<li class="list-group-item">
			<div class="form-group row mb-0">
				<label class="col-md-2 col-form-label" for="wr_1">다운 점수</label>
				<div class="col-md-3">
					<div class="input-group">
						<input type="text" name="wr_1" id="wr_1" value="<?php echo isset($write['wr_1']) ? $write['wr_1'] : ''; ?>" class="form-control" placeholder="양수 입력">
