...
<ul class="list-group">
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">다운 설정</label>
			<div class="col-sm-10">
				<div class="table-responsive">
					...
					<tr>
					<td class="text-center">다운 유지기간</td>
					<td class="text-center">
						<div class="input-group">
							<?php $boset['down_term'] = isset($boset['down_term']) ? (int)$boset['down_term'] : 0; ?>
							<input type="text" class="form-control" name="boset[down_term]" value="<?php echo $boset['down_term'] ?>">
					...
					<td class="text-muted">
						설정일 경과 후 재다운시 포인트 차감함(0이면 한번만 차감)
					</td>
					</tr>
					<tr>
					<td class="text-center">등록자 적립율</td>
					<td class="text-center">
						<div class="input-group">
							<?php $boset['save_rate'] = isset($boset['save_rate']) ? (int)$boset['save_rate'] : 100; ?>
							<input type="text" class="form-control" name="boset[save_rate]" value="<?php echo $boset['save_rate'] ?>">
							<div class="input-group-append">
	...
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">익명 설정</label>
			<div class="col-sm-10">
				<div class="table-responsive">
					<table class="table table-bordered mb-0">
					<tbody>
					...
					<tr>
					<td class="text-center">실명모드</td>
					<td class="text-center">
						<div class="custom-control custom-checkbox">
							<input type="checkbox" name="boset[nuse]" value="1"<?php echo get_checked('1', $boset['nuse'])?> class="custom-control-input" id="idCheck<?php echo $idn ?>">
					...
					<tr>
					<td class="text-center">익명헤드</td>
					<td class="text-center">
						<input type="text" name="boset[nhead]" value="<?php echo $boset['nhead'];?>" size="10" class="form-control"> 
					</td>
					<td class="text-muted">
						ex) 익명 등
					</td>
					...
					<tr>
					<td class="text-center">익명타입</td>
					<td class="text-center">
						<select name="boset[ntype]" class="custom-select">
					...
					<tr>
					<td class="text-center">익명길이</td>
					<td class="text-center">
						<div class="input-group">
							<input type="text" class="form-control" name="boset[ntail]" value="<?php echo $boset['ntail'] ?>" size="4">
							<div class="input-group-append">
								 <span class="input-group-text">글자</span>
							</div>
						</div>
					</td>
					<td class="text-muted">
					...
					<tr>
					<td class="text-center">익명유지</td>
					<td class="text-center">
						<div class="input-group">
							<input type="text" class="form-control" name="boset[nday]" value="<?php echo $boset['nday'] ?>" size="4">
							<div class="input-group-append">
