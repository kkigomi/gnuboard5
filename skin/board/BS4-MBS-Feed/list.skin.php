...
$list_style = (in_array($list_style, array('list', 'gallery', 'webzine'))) ? $list_style : 'gallery';
							...
							<div class="dropdown-menu dropdown-menu-right p-0 border-0 bg-transparent text-right">
								<div class="btn-group-vertical">
									...
									<?php if ($is_checkbox) { ?>
										...
										<button type="submit" name="btn_submit" value="수집제외" onclick="document.pressed=this.value" class="btn btn-primary py-2">
...
function fboardlist_submit(f) {
	...
	if(document.pressed == "수집제외") {
		if (!confirm("선택한 게시물을 피드수집에서 제외하시겠습니까?\n\n수집 제외된 글은 관리자에게만 노출되며, 마지막 페이지에 출력됩니다."))
			return false;
