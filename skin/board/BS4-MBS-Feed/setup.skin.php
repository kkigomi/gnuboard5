...
<ul class="list-group">
	<li class="list-group-item bg-light border-top-0">
		<a href="#feed_guide" data-toggle="collapse" aria-expanded="false" aria-controls="feed_guide" class="float-right">
			<b>피드 설정방법 안내</b>
		</a>
		<b>피드 설정</b>
	</li>
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">수집 피드</label>
			<div class="col-sm-10">
				<div id="feed_guide" class="collapse">
					<?php include_once($board_skin_path.'/feed.guide.php') ?>
				</div>
				<?php $boset['feed'] = isset($boset['feed']) ? $boset['feed'] : ''; ?>
				<textarea name="boset[feed]" class="form-control" rows="5"><?php echo $boset['feed'] ?></textarea>
				<p class="form-text text-muted">
					유튜브 수집은 환경설정 > 나리야 설정에서 유튜브 API 키값을 등록해야 작동합니다.
				</p>
			</div>
		</div>
	</li>
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">제외 피드</label>
			<div class="col-sm-10">
				<?php $boset['fout'] = isset($boset['fout']) ? $boset['fout'] : ''; ?>
				<textarea name="boset[fout]" class="form-control" rows="3"><?php echo stripslashes($boset['fout']) ?></textarea>
				<p class="form-text text-muted">
					등록된 단어가 있는 피드는 수집이 되지 않으며, 단어는 콤마(,)로 구분해서 등록해 주세요.
				</p>
			</div>
		</div>
	</li>
	<li class="list-group-item">
		<div class="form-group row mb-0">
			<label class="col-sm-2 col-form-label">수집 설정</label>
			<div class="col-sm-10">
				<div class="table-responsive">
					...
					<td>
						<div class="input-group">
							<?php $boset['cache'] = isset($boset['cache']) ? $boset['cache'] : '30'; ?>
							<input name="boset[cache]" value="<?php echo $boset['cache'] ?>" class="form-control">
					...
					<td class="text-center">
						<div class="custom-control custom-checkbox">
							<?php $boset['move'] = isset($boset['move']) ? $boset['move'] : ''; ?>
							<input type="checkbox" name="boset[move]" value="1"<?php echo get_checked('1', $boset['move'])?> class="custom-control-input" id="idCheck<?php echo $idn ?>">
					...
					<td class="text-center">
						<div class="custom-control custom-checkbox">
							<?php $boset['db_new'] = isset($boset['db_new']) ? $boset['db_new'] : ''; ?>
							<input type="checkbox" name="boset[db_new]" value="1"<?php echo get_checked('1', $boset['db_new'])?> class="custom-control-input" id="idCheck<?php echo $idn ?>">
							<label class="custom-control-label" for="idCheck<?php echo $idn; $idn++; ?>"></label>
						</div>
					</td>
					<td class="text-muted">
					...
					<td class="text-center">
						<div class="custom-control custom-checkbox">
							<input type="checkbox" name="re_feed" value="1" class="custom-control-input" id="idCheck<?php echo $idn ?>">
							<label class="custom-control-label" for="idCheck<?php echo $idn; $idn++; ?>"></label>
						</div>
					</td>
					<td class="text-muted">
		...
		<div class="form-group row mb-0">
			...
			<div class="col-sm-10">
				<div class="table-responsive">
					...
					<td class="text-center">
						<?php $wset['list_style'] = isset($wset['list_style']) ? $wset['list_style'] : 'gallery';	?>
