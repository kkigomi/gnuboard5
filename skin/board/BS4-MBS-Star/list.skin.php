...
// 별점 컬러
$star_color = (isset($boset['star']) && $boset['star']) ? 'txt-'.$boset['star'] : 'txt-primary';
    ...
    <form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <div id="bo_btn_top" class="clearfix f-de font-weight-normal mb-2">
            <div class="d-sm-flex align-items-center">
                ...
                <div class="px-3 px-sm-0 text-end">
                    <?php if ($is_admin == 'super' || $admin_href || $is_auth || IS_DEMO) {  ?>
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn_admin nofocus dropdown-toggle dropdown-toggle-split p-1" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false" title="게시판 관리 옵션">
                                <i class="fa fa-cog fa-spin fa-fw fa-md" aria-hidden="true"></i>
                                <span class="visually-hidden">게시판 관리 옵션</span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end p-0 border-0 bg-transparent text-end">
                    ...
                    <?php } ?>
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn_b01 nofocus dropdown-toggle dropdown-toggle-split p-1" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false" title="게시물 정렬">
                            <?php
                            switch($sst) {
                            ...
                            <span class="visually-hidden"><?php echo $sst_txt ?></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end p-0 border-0 bg-transparent text-end">
                            <div class="btn-group-vertical bg-white border rounded py-1">
                                <?php echo str_replace('>', ' class="btn px-3 py-1 text-start" role="button">', subject_sort_link('wr_datetime', $qstr2, 1)) ?>
                                날짜순
                                </a>
                                <?php echo str_replace('>', ' class="btn px-3 py-1 text-start" role="button">', subject_sort_link('wr_hit', $qstr2, 1)) ?>
                                조회순
                                </a>
                                <?php if($is_good) { ?>
                                    <?php echo str_replace('>', ' class="btn px-3 py-1 text-start" role="button">', subject_sort_link('wr_good', $qstr2, 1)) ?>
                                    추천순
                                    </a>
                                <?php } ?>
                                <?php if($is_nogood) { ?>
                                    <?php echo str_replace('>', ' class="btn px-3 py-1 text-start" role="button">', subject_sort_link('wr_nogood', $qstr2, 1)) ?>
                                    비추천순
                                    </a>
                                <?php } ?>
                            </div>
                    ...
                    <?php if($list_style != 'list') { ?>
                        <button type="button" class="btn btn_b01 nofocus p-1" title="리스트 스타일" onclick="list_style('list');">
                            ...
                            <span class="visually-hidden">리스트 스타일</span>
                        </button>
                    <?php } ?>
                    <?php if($list_style != 'webzine') { ?>
                        <button type="button" class="btn btn_b01 nofocus p-1" title="웹진 스타일" onclick="list_style('webzine');">
                            ...
                            <span class="visually-hidden">웹진 스타일</span>
                        </button>
                    <?php } ?>
                    <?php if($list_style != 'gallery') { ?>
                        <button type="button" class="btn btn_b01 nofocus p-1" title="갤러리 스타일" onclick="list_style('gallery');">
                            ...
                            <span class="visually-hidden">갤러리 스타일</span>
                        </button>
                    <?php } ?>
                    <button type="button" class="btn btn_b01 nofocus p-1" title="게시판 검색" data-bs-toggle="collapse" data-bs-target="#bo_search" aria-expanded="false" aria-controls="bo_search">
                        <i class="fa fa-search fa-fw fa-md" aria-hidden="true"></i>
                        <span class="visually-hidden">게시판 검색</span>
                    </button>
                    <?php if ($write_href && !$wr_id) { ?>
                        <a href="<?php echo $write_href ?>" class="btn btn-primary nofocus py-1 ms-2" role="button">
