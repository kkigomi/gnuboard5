...
<section id="bo_list" class="mb-4">
    ...
    <div class="na-table d-none d-md-table w-100 mb-0">
        <div class="<?php echo $head_class ?> d-md-table-row">
            ...
            <div class="d-md-table-cell nw-6 pr-md-1">별점</div>
    ...
    <ul id="list-body" class="na-table d-md-table w-100">
        ...
        for ($i=0; $i < $list_cnt; $i++) {
            ...
            if ($list[$i]['is_notice']) { // 공지사항
                $li_css = ' bg-light';
                $list[$i]['num'] = '<span class="na-notice bg-'.$head_color.'"></span><span class="visually-hidden">공지사항</span>';
                ...
                $list[$i]['num'] = '<span class="visually-hidden">번호</span>'.$list[$i]['num'];
            }
            ...
            if($is_popover) {
                ...
                if($thumb) {
                    $wr_popover = ' data-bs-toggle="popover-img" data-img="'.$thumb.'"';
                }
            }
            ...
            <li class="list-item d-md-table-row px-3 py-2 p-md-0 text-md-center text-muted border-bottom<?php echo $li_css;?>">
                ...
                <div class="d-md-table-cell text-start py-md-2 pr-md-1">
                    <div class="na-title float-md-start">
                        <div class="na-item">
                            <?php if ($is_checkbox) { ?>
                                <input type="checkbox" class="mb-0 me-2" name="chk_wr_id[]" value="<?php echo $list[$i]['wr_id'] ?>" id="chk_wr_id_<?php echo $i ?>">
                            <?php } ?>
                            ...
                            <?php if($list[$i]['wr_comment']) { ?>
                                <div class="na-info">
                                    ...
                                    <span class="count-plus text-danger">
                ...
                <div class="float-end float-md-none d-md-table-cell nw-10 nw-md-auto text-start f-sm font-weight-normal ps-2 py-md-2 pr-md-1">
                    <span class="visually-hidden">등록자</span>
                    <?php echo na_name_photo($list[$i]['mb_id'], $list[$i]['name']) ?>
                </div>
                <div class="float-start float-md-none d-md-table-cell nw-6 nw-md-auto f-sm font-weight-normal py-md-2 pr-md-1">
                    <span class="visually-hidden">별점</span>
                    <?php
                    $star = na_star($list[$i]['as_star_cnt'], $list[$i]['as_star_score'], $star_color);
                    echo $star['star'];
                    ?>
                </div>
                <div class="float-start float-md-none d-md-table-cell nw-6 nw-md-auto f-sm font-weight-normal py-md-2 pr-md-1">
                ...
                <div class="float-start float-md-none d-md-table-cell nw-4 nw-md-auto f-sm font-weight-normal py-md-2 pr-md-1">
                    <i class="fa fa-eye d-md-none" aria-hidden="true"></i>
                    <span class="visually-hidden">조회</span>
                    <?php echo $list[$i]['wr_hit'] ?>
                </div>
                <?php if($is_good) { ?>
                    <div class="float-start float-md-none d-md-table-cell nw-3 nw-md-auto f-sm font-weight-normal py-md-2 pr-md-1">
